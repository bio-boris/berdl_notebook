...
# Create user if it doesn't exist, with home and skel.
...
touch /home/${JUPYTERHUB_USER}/.custom_profile
chown "${JUPYTERHUB_USER}:${JUPYTERHUB_GROUP}" "/home/${JUPYTERHUB_USER}/.custom_profile"
